...
export default function CEOSection() {
  ...
  return (
    <section className="relative py-14 sm:py-20 md:py-24 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden font-alt">
      ...
      >
        ...
        >
          ...
          <h2 className="mt-4 sm:mt-5 text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight text-gray-900 leading-snug font-mono">
            Meet Our{" "}
